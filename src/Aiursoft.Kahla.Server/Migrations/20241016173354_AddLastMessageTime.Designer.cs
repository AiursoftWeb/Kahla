...
namespace Aiursoft.Kahla.Server.Migrations
{
    ...
    [Migration("20241016173354_AddLastMessageTime")]
    partial class AddLastMessageTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.BlockRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.ChatThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.ContactRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.Device", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", b =>
                {
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.UserThreadRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.BlockRecord", b =>
                {
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", "Creator")
                        .WithMany("BlockList")
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", "Target")
                        .WithMany("BlockedBy")
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.ChatThread", b =>
                {
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.UserThreadRelation", "OwnerRelation")
                        .WithMany()
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.Device", b =>
                {
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", "KahlaUser")
                        .WithMany("HisDevices")
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.Message", b =>
                {
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", "Sender")
                        .WithMany("MessagesSent")
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.ChatThread", "Thread")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.Report", b =>
                {
                    ...
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", "Trigger")
                        .WithMany("Reported")
            ...
            modelBuilder.Entity("Aiursoft.Kahla.SDK.Models.Entities.UserThreadRelation", b =>
                {
                    ...
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Aiursoft.Kahla.SDK.Models.Entities.KahlaUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
